...
IF NOT EXISTS(SELECT * FROM EquipamentoDisponivel WHERE  descr = '1')
...
IF NOT EXISTS(SELECT * FROM EquipamentoDisponivel WHERE tipo = 'Bola' AND eqId = 3)
...
IF NOT EXISTS(SELECT * FROM EquipamentoDisponivel WHERE  eqId = 2 AND tipo = 'NewType')
...
IF EXISTS(SELECT * FROM EquipamentoDisponivel WHERE eqId = 3)
...
BEGIN CATCH
	...
	IF NOT EXISTS(SELECT * FROM EquipamentoDisponivel WHERE eqId = 2)
...
IF EXISTS(SELECT * FROM EquipamentoDisponivel WHERE eqId = 4)
